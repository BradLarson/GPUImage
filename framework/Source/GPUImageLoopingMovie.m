#import "GPUImageLoopingMovie.h"
#import "GPUImageMovieWriter.h"

@interface GPUImageLoopingMovie ()
{
...
@implementation GPUImageLoopingMovie
...
- (void)startProcessing
{
    ...
    GPUImageLoopingMovie __block *blockSelf = self;
...
- (void)processAsset
{
    __unsafe_unretained GPUImageLoopingMovie *weakSelf = self;
    NSError *error = nil;
    ...
    BOOL shouldRecordAudioTrack = NO; //(([audioTracks count] > 0) && (weakSelf.audioEncodingTarget != nil) );
    ...
    {
        while (reader.status == AVAssetReaderStatusReading && keepLooping)
        {
                [weakSelf readNextVideoFrameFromOutput:readerVideoTrackOutput];
