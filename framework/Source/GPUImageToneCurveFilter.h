...
@property(readwrite, nonatomic, strong) NSArray *redControlPoints;
@property(readwrite, nonatomic, strong) NSArray *greenControlPoints;
@property(readwrite, nonatomic, strong) NSArray *blueControlPoints;
