...
GLfloat *
CreateFloatArrayWithSteps(NSArray *steps) {
...
GLfloat *
CreateFloatArrayWithColors(NSArray *colors) {
   ...
   for (NSColor *color in colors) {
      ...
      cColors[j] = [aColor redComponent];
      cColors[j+1] = [aColor greenComponent];
      cColors[j+2] = [aColor blueComponent];
      cColors[j+3] = [aColor alphaComponent];
      j += 4;
   }
   return cColors;
}
...
- (id)init {
   ...
   self.colors = @[[NSColor redColor], [NSColor greenColor], [NSColor blueColor], [NSColor whiteColor]];
...
- (id)init {
   ...
   self.colors = @[[NSColor blackColor], [NSColor whiteColor]];
