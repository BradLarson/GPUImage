...
typedef enum { GPUIMAGE_SATURATION, GPUIMAGE_CONTRAST, GPUIMAGE_BRIGHTNESS, GPUIMAGE_EXPOSURE, GPUIMAGE_SHARPEN, GPUIMAGE_TRANSFORM, 
               GPUIMAGE_TRANSFORM3D, GPUIMAGE_CROP, GPUIMAGE_GAMMA, GPUIMAGE_HAZE, GPUIMAGE_SEPIA, GPUIMAGE_COLORINVERT, GPUIMAGE_GRAYSCALE, 
               GPUIMAGE_THRESHOLD, GPUIMAGE_PIXELLATE, GPUIMAGE_SOBELEDGEDETECTION, GPUIMAGE_SKETCH, GPUIMAGE_TOON, GPUIMAGE_POSTERIZE, 
               GPUIMAGE_KUWAHARA, GPUIMAGE_VIGNETTE, GPUIMAGE_GAUSSIAN, GPUIMAGE_GAUSSIAN_SELECTIVE, GPUIMAGE_FASTBLUR, GPUIMAGE_SWIRL, 
               ...
               GPUIMAGE_HARDLIGHTBLEND, GPUIMAGE_SOFTLIGHTBLEND, GPUIMAGE_CUSTOM, GPUIMAGE_FILECONFIG, GPUIMAGE_FILTERGROUP, GPUIMAGE_NUMFILTERS} GPUImageShowcaseFilterType; 
