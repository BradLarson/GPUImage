    ...
    switch(filterType)
    {
        ...
        case GPUIMAGE_LEVELS: {
            ...
            if (value < 0.0) {
                ...
                [(GPUImageLevelsFilter *)filter setRedMin:0.0 gamma:1.0 max:value minOut:0.0 maxOut:1.0];
                [(GPUImageLevelsFilter *)filter setGreenMin:0.0 gamma:1.0 max:value minOut:0.0 maxOut:1.0];
                [(GPUImageLevelsFilter *)filter setBlueMin:0.0 gamma:1.0 max:value minOut:0.0 maxOut:1.0];
            }
        }; break;
